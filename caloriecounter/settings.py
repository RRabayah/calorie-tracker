...
SECRET_KEY = 'django-insecure-q1ly^jdkctfgr)=ue3_g*q--e_lla5$#-u)jdf!b+s478myqvu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [
    "rrabayah.pythonanywhere.com",
]
...
LOGIN_REDIRECT_URL = '/calories/'  # or whatever your main screen URL is
